        ...
        <form action="{{ route('animals.update', $animal->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div class="md:col-span-2 p-4 border rounded-lg bg-emerald-50/50 dark:bg-emerald-900/10" 
                     x-data="{ forSale: {{ old('is_for_sale', $animal->is_for_sale) ? 'true' : 'false' }} }">
                    ...
                    <div x-show="forSale" x-cloak class="grid gap-4 md:grid-cols-2">
                        <div>
                            ...
                            <input type="number" id="sale_price" name="sale_price" :required="forSale" value="{{ old('sale_price', $animal->sale_price) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                        </div>
                        <div class="md:col-span-2">
