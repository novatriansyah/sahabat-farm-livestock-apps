<x-app-layout>
    <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow dark:bg-gray-800">
        ...
        <form action="{{ route('animals.exit.store', $animal->id) }}" method="POST">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-1">
                <div>
                    ...
                    <select id="exit_type" name="exit_type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" onchange="togglePriceField(this.value)">
                        <option value="JUAL">Penjualan (Sale)</option>
                        <option value="MATI">Kematian (Death)</option>
                    </select>
                </div>
                <div>
                    <label for="exit_date" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal</label>
                ...
                <div id="customer-fields">
                    <div class="mb-4">
                        ...
                        <input type="text" id="customer_name" name="customer_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                    </div>
                    <div>
                        <label for="customer_contact" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kontak Pelanggan (Opsional)</label>
                        <input type="text" id="customer_contact" name="customer_contact" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                    </div>
                </div>
                <div>
                    <label for="notes" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Catatan / Penyebab Kematian</label>
            ...
            <button type="submit" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Proses Keluar</button>
        </form>
    </div>
