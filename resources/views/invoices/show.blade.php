        ...
        <div class="mb-4 flex items-center justify-between no-print">
            ...
            <div class="flex gap-2">
                ...
                @if($invoice->status == 'DRAFT')
                    <a href="{{ route('invoices.edit', $invoice->id) }}" class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 no-print">
                        Edit Draft
                    </a>
                @endif
                @endif
