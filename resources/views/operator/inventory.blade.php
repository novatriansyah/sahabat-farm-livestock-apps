<x-app-layout>
    <div class="max-w-md mx-auto bg-white p-4 rounded-lg shadow dark:bg-gray-800">
        <h2 class="text-xl font-bold mb-4 dark:text-white">Daily Feeding & Usage</h2>
        ...
        <form action="{{ route('inventory.usage.store') }}" method="POST">
            @csrf
            <div class="mb-4">
                <label for="item_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select Feed/Item</label>
            ...
            <div class="mb-4">
                <label for="location_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Target Cage (Optional)</label>
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Select a cage to calculate precise HPP.</p>
            </div>
            ...
            <button type="submit" class="w-full text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">Record Usage</button>
        </form>
    </div>
</x-app-layout>
