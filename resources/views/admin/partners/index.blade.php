            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4 flex space-x-2">
                        @if(!$partner->user)
                            <a href="{{ route('users.create', ['role' => 'MITRA', 'partner_id' => $partner->id]) }}" class="font-medium text-green-600 dark:text-green-500 hover:underline">Buat User</a>
                        @else
                        ...
                        <a href="{{ route('partners.edit', $partner) }}" class="font-medium text-yellow-600 dark:text-yellow-500 hover:underline">Ubah</a>
