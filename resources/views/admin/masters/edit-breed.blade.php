        ...
        <form action="{{ route('masters.breed.update', $breed->id) }}" method="POST">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="number" id="min_weight_mate" name="min_weight_mate" min="0" value="{{ old('min_weight_mate', $breed->min_weight_mate) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                </div>
                <div>
                    <label for="min_age_mate_months" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Min Age (Months)</label>
                    <input type="number" id="min_age_mate_months" name="min_age_mate_months" min="0" value="{{ old('min_age_mate_months', $breed->min_age_mate_months) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                </div>
                <div>
