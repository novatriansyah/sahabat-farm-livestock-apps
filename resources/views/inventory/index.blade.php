<x-app-layout>
    <div class="flex justify-between items-center mb-4">
        ...
        <div class="flex gap-2">
            <button data-modal-target="usage-modal" data-modal-toggle="usage-modal" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">Record Usage</button>
            <button data-modal-target="purchase-modal" data-modal-toggle="purchase-modal" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Add Stock (Purchase)</button>
        </div>
    </div>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Record Inventory Usage</h3>
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4" action="{{ route('inventory.usage.store') }}" method="POST">
                        @csrf
                        <div>
                            <label for="item_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Item</label>
                        ...
                        <div>
                            <label for="qty_used" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Qty Used</label>
                        ...
                        <div>
                            <label for="qty_wasted" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Qty Wasted</label>
                        ...
                        <div>
                             <label for="usage_date" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Date</label>
                        ...
                        <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Save Usage</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div id="purchase-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Add Stock (Purchase)</h3>
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4" action="{{ route('inventory.purchase.store') }}" method="POST">
                        @csrf
                        <div>
                            <label for="p_item_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Item</label>
                        ...
                        <div>
                            <label for="qty" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Quantity Purchased</label>
                        ...
                        <div>
                            <label for="price_total" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Total Price (IDR)</label>
                        ...
                        <div>
                             <label for="purchase_date" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Date</label>
                        ...
                        <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Save Purchase</button>
                    </form>
                </div>
            </div>
        </div>
