        ...
        <form action="{{ route('inventory.update', $item->id) }}" method="POST">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="number" id="dosage_per_kg" name="dosage_per_kg" value="{{ old('dosage_per_kg', $item->dosage_per_kg) }}" step="0.001" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                </div>
            </div>
